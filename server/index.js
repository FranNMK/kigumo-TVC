...
app.use(session({
  secret: process.env.SESSION_SECRET || 'kigumo-tvc-dev-secret-change-in-production',
  resave: false,
...
// Courses routes (placeholder - will be rebuilt in Priority 2)
app.use('/api/v1/courses', require('./routes/courses'));

// Timetable routes (placeholder - will be rebuilt later)
app.use('/api/v1/timetable', require('./routes/timetable'));

// Materials routes (placeholder - will be rebuilt later)
